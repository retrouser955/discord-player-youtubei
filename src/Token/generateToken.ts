// @ts-nocheck
// No idea where to put this file so imma put it here, i'll leave all the functions in the same file so that i dont affect or make too many files
// IMPORTANT NOTE: alot of typescript errors here u might wanna look at, imma just put in the stuffs that worked for me first
