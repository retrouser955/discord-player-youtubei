...
export type IntervalGeneratorOptions = IGeneratorOptions & Omit<GeneratorOptions, "skipPuppeteerCheck">

export async function generateTrustedTokenInterval(options: IntervalGeneratorOptions) {
    if(!options.interval) options.interval = 6.048e+8 // 1 week in ms
